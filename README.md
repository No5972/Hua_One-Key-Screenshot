...
| 百分浏览器   | √        |  ~~需选择“使用浏览器内置Flash”的单选框~~ 自动下载的Flash　32版本已经在1月12日无法使用，需选择“使用指定路径的Flash”的单选框并手动指定Flash路径 | √ | ~~需选择“使用浏览器内置Flash”的单选框~~ 自动下载的Flash　32版本已经在1月12日无法使用，需选择“使用指定路径的Flash”的单选框并手动指定Flash路径 |
